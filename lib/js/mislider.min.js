...
!function (a, b, c, d) {
    ...
    var e = function (c, e) {
        ...
        function i(a) {
            var b = !1;
            if ("undefined" != typeof Modernizr) Modernizr.csstransforms && (b = !0); else {
                var c = a.style;
        ...
        return j.optionsInit = {
            ...
            var b, c, e, g = !(a.isNumeric(j.options.slideWidth) && parseInt(j.options.slideWidth, 10) > 0),
                i = !(a.isNumeric(j.options.stageHeight) && parseInt(j.options.stageHeight, 10) > 0);
            return j.slides.each(function () {
                var b = a(this), c = b.find("img");
                if (j.imagesLoaded = c.prop("complete"), !j.imagesLoaded) return c.on("load", j.setup), !1;
                if (b.addClass(j.options.classSlide), b.children().hasClass(j.classSlideContainer) || b.wrapInner("<div class='" + j.classSlideContainer + "'></div>"), g) {
                    var d = b.outerWidth();
                    d > j.slideWidthCurrent && (j.slideWidthCurrent = d)
                }
                if (i) {
                    var e = b.outerHeight();
                    e > j.stageHeight && (j.stageHeight = e)
                }
                ...
                width: j.sliderWidth
            }), j.updateNavList(j.indexCurrent), j.slideSetup(), j.updateNavButtons(), j.stage.fadeTo(600, 1), j.autoplayOn(j.increment), a.isFunction(j.options.slidesLoaded) && j.options.slidesLoaded(), this) : !1
                ...
                if (j.slidesContinuous ? (b < j.indexFirst ? i = b + j.slidesLengthOrig : b > j.indexLast && (i = b - j.slidesLengthOrig), i !== b && (k = j.indexCurrent + j.slidesLengthOrig, b > i && (k = j.indexCurrent - j.slidesLengthOrig))) : i = h(b), g = h(i) - h(k)) {
                    ...
                    if (a.isFunction(c) && c(), a.isFunction(j.options.beforeTrans) && j.options.beforeTrans(), l = function () {
                        ...
                        100 !== j.slideScaling && (m.css({
                            ...
                            marginRight: "0",
                            borderSpacing: "100px"
                        }), j.options.centerV && m.children().first().css({marginTop: m.data("slideMarginTopCurrent")})), m.addClass(j.classCurrent).siblings().removeClass(j.classCurrent), j.slider.css("left", f(k)), 100 !== j.slideScaling && (j.slideCurrent.css({
                        ...
                        }), j.options.centerV && j.slideCurrent.children().first().css({marginTop: j.slideCurrent.data("slideMarginTop")})), j.indexCurrent = k, j.slideCurrent = j.slides.eq(j.indexCurrent)
                    }
            ...
            return 100 !== j.slideScaling && (d.animate({
                ...
                marginRight: "0",
                width: j.slideWidthCurrent
            }, {duration: j.speed, queue: !1}).animate({borderSpacing: "100px"}, {
                step: function (b) {
                    a(this).css({transform: "scale(" + 100 / b + ")"})
                }, duration: j.speed, queue: !1
            }), j.slideCurrent.animate({
                marginLeft: j.scalingMargin,
                marginRight: j.scalingMargin,
                width: j.scalingWidth
            }, {duration: j.speed, queue: !1}).animate({borderSpacing: j.slideScaling}, {
                step: function (b) {
                    a(this).css({transform: "scale(" + 100 / b + ")"})
                }, duration: j.speed, queue: !1
            }), j.options.centerV && (d.children().first().animate({marginTop: d.data("slideMarginTopCurrent")}, {
                duration: j.speed,
                queue: !1
            }), j.slideCurrent.children().first().animate({marginTop: j.slideCurrent.data("slideMarginTop")}, {
                duration: j.speed,
                queue: !1
            }))), j.slider.animate({left: f(b)}, {
            ...
            var c, e = a(b);
            return c = a("<div class='" + j.options.classNavButtons + "'><a class='" + j.classPrev + "'>Prev</a><a class='" + j.classNext + "'>Next</a></div>"), c.css({opacity: j.options.navButtonsShow ? j.navButtonsOpacity : 0}).children("a").on("click", function (a) {
            ...
            }).children("a").css({height: j.stageHeight, paddingTop: (50 + j.offsetV) * j.stageHeight / 100})
            ...
            return j.slides.each(function (b) {
                ...
                }).eq(0).html(), d ? e = d : (d = a(this).find("figcaption").eq(0).html(), d ? e = d : (d = a(this).find("img").eq(0).attr("title"), d && (e = d))), c += "<li><a title='" + e + "'>" + e + "</a></li>"
            ...
            } else j.after = j.resetSlider; else j.autoplayOff(), j.stage.removeAttr("style"), j.slider.removeAttr("style"), j.slides.removeAttr("style"), j.slides.filter("." + j.classSlideClone).remove(), j.slides = j.slider.children(j.options.selectorSlide), j.stageHeight = 0, j.slideWidthCurrent = 0, j.slideScaling = j.optionsInit.slideScaling, j.indexCurrent -= j.slidesToClone, j.indexFirst = 0, j.increment = j.optionsInit.increment, j.after = !1, j.setup(), j.slideSetup(), j.updateNavButtons(), j.autoplayOn(j.increment);
            return this
            ...
            j.slides.each(function (b) {
                ...
                c.css({
                    ...
                    display: "block",
                    opacity: "1"
                }), j.options.centerV && g(c, "slideMarginTopCurrent"), c.css({width: j.scalingWidth}), 100 !== j.slideScaling && c.css({
                    marginLeft: j.scalingMargin,
                    marginRight: j.scalingMargin,
                    transform: "scale(" + 100 / j.slideScaling + ")",
                    borderSpacing: j.slideScaling
                }), j.options.centerV && c.children().first().css({marginTop: g(c, "slideMarginTop")}), b === j.indexCurrent && (c.css({
                    borderSpacing: "100px",
                    width: j.slideWidthCurrent,
                    marginLeft: 0,
                    marginRight: 0,
                    transform: "scale(1)"
                }).addClass(j.classCurrent).siblings().removeClass(j.classCurrent), j.options.centerV && c.children().first().css({marginTop: g(c, "slideMarginTopCurrent")}))
            })
        }, j.init(c, e), this
    };
